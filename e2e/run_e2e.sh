...
HEADLESS=true SUPABASE_URL="$URL" SUPABASE_ANON_KEY="$KEY" node --no-warnings --experimental-vm-modules node_modules/jest/bin/jest.js --config=jest.e2e.config.js --runInBand --forceExit --detectOpenHandles "$@"
